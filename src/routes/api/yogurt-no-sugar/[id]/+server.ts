        ...
        try {
            ...
            const report = {
                ...
                measurements: {
                    ...
                    sng: row.sng,
                    titratableAcidity: row.titratable_acidity,
                ...
                bacteriological: {
                    ...
                    totalColiforms: row.total_coliforms,
                    fecalColiforms: row.fecal_coliforms,
                    escherichiaColi: row.escherichia_coli,
                    yeastMoldCount: row.yeast_mold_count
                },
