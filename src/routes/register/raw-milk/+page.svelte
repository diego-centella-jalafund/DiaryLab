<script lang="ts">
	...
	let date = '2025-07-27';
	let analysisDate = '2025-07-27';
	let sampleNumberEvening = 532;
	let sampleNumberEarlyMorning = 533;
	let sampleNumberGmp2 = 534;
	let samplingTimeEvening = '';
	let samplingTimeEarlyMorning = '';
	let samplingTimeGmp2 = '';
	let samplingTemperatureEvening = 4.4;
	let samplingTemperatureEarlyMorning = 21.7;
	let samplingTemperatureGmp2 = 4.3;
	let ph20CEvening = 6.63;
	let ph20CEarlyMorning =6.63;
	let ph20CGmp2 = 6.62;
	let temperatureEvening = 18.8;
	let temperatureEarlyMorning = 19.8;
	let temperatureGmp2 = 19.2;
	let titratableAcidityEvening = 0.15;
	let titratableAcidityEarlyMorning = 0.15;
	let titratableAcidityGmp2 = 0.15;
	let density20CEvening = 1.033;
	let density20CEarlyMorning = 1.032;
	let density20CGmp2 = 1.031;
	let fatContentEvening = '';
	let fatContentEarlyMorning = '';
	let fatContentGmp2 = '';
	let nonFatSolidsEvening = 9.2;
	let nonFatSolidsEarlyMorning = 9.1;
	let nonFatSolidsGmp2 = 8.6;
	let alcoholTestEvening = 'negativo';
	let alcoholTestEarlyMorning = 'lig. positivo';
	let alcoholTestGmp2 = 'lig. positivo';
	let tramEvening = 'decloracion +5h';
	let tramEarlyMorning = 'decloracion +5h';
	let tramGmp2 = 'decloracion +3h';
