<script lang="ts">
    ...
    let fecalColiformCount = '';
    let sporeFormingBacteria = '';
    let escherichiaColi = '';
    ...
    async function fetchReport(retryCount = 0) {
        ...
        try {
            const response = await fetch(`/api/semi-cheese/${data.id}`, {
    ...
    async function saveForm(retryCount = 0) {
        ...
        const formData = {
            ...
            fecalColiformCount: parseFloat(fecalColiformCount) || 0,
            sporeFormingBacteria: parseFloat(sporeFormingBacteria) || 0,
...
<AuthGuard manual={true} forceLogin={true}>
    <div slot="authed" let:user>
        <section class="form-section">
            <h1>Informe de Queso Semi Maduro (ID: {data.id})</h1>
                ...
                <div class="section">
                    ...
                    <table class="result.datas-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Recuento de Bacterias Formadoras de Esporas</td>
                                <td>UFC/g</td>
